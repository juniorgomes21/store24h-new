    ...
    public void configure(HttpSecurity http) throws Exception{
        http
                ...
                //Padrão API ADM
                    ...
                    .antMatchers("/stubs/handler_api/getNumberStatus").hasAuthority(Role.ADMINISTRADO.getNome())
                    .antMatchers("/stubs/handler_api/getNumberStatux").permitAll()
                    .antMatchers("/stubs/handler_api/getBalance").hasAuthority(Role.ADMINISTRADO.getNome())
                    .antMatchers("/stubs/handler_api/getNumber").hasAuthority(Role.ADMINISTRADO.getNome())
                    .antMatchers("/stubs/handler_api/status").hasAuthority(Role.ADMINISTRADO.getNome())
                    .antMatchers("/stubs/handler_api/prices").hasAuthority(Role.ADMINISTRADO.getNome())
                    .antMatchers("/stubs/handler_api/listaDePaisesOperadoras/**").hasAuthority(Role.ADMINISTRADO.getNome())
                    .antMatchers("/stubs/handler_api/listServicos").hasAuthority(Role.ADMINISTRADO.getNome())
                    .antMatchers("/stubs/handler_api/criarChaveApi").hasAuthority(Role.ADMINISTRADO.getNome())
